...
# Nuevas muestras
nuevas_muestras_clase_1 <- rnorm(n_necesario, mean = mu_post_clase_1, sd = sqrt(sigma2_post_clase_1))
nuevas_muestras_clase_2 <- rnorm(n_necesario, mean = mu_post_clase_2, sd = sqrt(sigma2_post_clase_2))
